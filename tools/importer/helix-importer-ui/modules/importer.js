...
import {
  ...
  html2docx,
  html2xml,
} from '../../helix-importer/src/importer/HTML2x.js';

import DOMUtils from '../../helix-importer/src/utils/DOMUtils.js';
import FileUtils from '../../helix-importer/src/utils/FileUtils.js';
import Loader from '../../helix-importer/src/utils/Loader.js';
import Blocks from '../../helix-importer/src/utils/Blocks.js';
import {
  rules,
...
async function html2xmlWrapper(url, document, transformCfg, params) {
  return html2xml(url, document, transformCfg, options, params);
}
